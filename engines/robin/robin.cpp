...
void RobinEngine::displayFunction18(int index, int x, int y, int flags) {
...
void RobinEngine::displayFunction1(byte *buf, int var1, int var2, int var4) {
	...
	for (int i = 0; i < 16; i++) {
		if (newBuf[0] != 0)
			((byte *)_mainSurface->pixels)[index2] = newBuf[0];
		if (newBuf[1] != 0)
			((byte *)_mainSurface->pixels)[index2 + 1] = newBuf[1];
		if (newBuf[2] != 0)
			((byte *)_mainSurface->pixels)[index2 + 2] = newBuf[2];
		if (newBuf[3] != 0)
			((byte *)_mainSurface->pixels)[index2 + 3] = newBuf[3];
		if (newBuf[4] != 0)
			((byte *)_mainSurface->pixels)[index2 + 4] = newBuf[4];
		if (newBuf[5] != 0)
			((byte *)_mainSurface->pixels)[index2 + 5] = newBuf[5];
		if (newBuf[6] != 0)
			((byte *)_mainSurface->pixels)[index2 + 6] = newBuf[6];
		if (newBuf[7] != 0)
			((byte *)_mainSurface->pixels)[index2 + 7] = newBuf[7];
		if (newBuf[8] != 0)
			((byte *)_mainSurface->pixels)[index2 + 8] = newBuf[8];
		if (newBuf[9] != 0)
			((byte *)_mainSurface->pixels)[index2 + 9] = newBuf[9];
		if (newBuf[10] != 0)
			((byte *)_mainSurface->pixels)[index2 + 10] = newBuf[10];
		if (newBuf[11] != 0)
			((byte *)_mainSurface->pixels)[index2 + 11] = newBuf[11];
		if (newBuf[12] != 0)
			((byte *)_mainSurface->pixels)[index2 + 12] = newBuf[12];
		if (newBuf[13] != 0)
			((byte *)_mainSurface->pixels)[index2 + 13] = newBuf[13];
		if (newBuf[14] != 0)
			((byte *)_mainSurface->pixels)[index2 + 14] = newBuf[14];
		if (newBuf[15] != 0)
...
void RobinEngine::displayFunction1a(byte *buf, int var2, int var4) {
...
void RobinEngine::displayFunction2(byte *buf, int var2, int var4) {
...
void RobinEngine::sub1652B(int var1) {
...
void RobinEngine::viewportScrollTo(int goalX, int goalY) {
...
void RobinEngine::renderCharacters(byte *buf, int x, int y) {
...
int RobinEngine::sub16B0C(int param1, int param2) {
...
int RobinEngine::sub16799(int param1, int index) {
...
void RobinEngine::sub13184(bool &forceReturnFl) {
...
int RobinEngine::sub13240(int posX, int posY, int var3, int var4) {
