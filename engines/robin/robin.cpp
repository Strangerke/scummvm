...
int RobinEngine::sub168DA(int x, int y) {
...
uint16 RobinEngine::sub168DA(byte var1h, byte var1l) {
...
uint16 RobinEngine::sub_16901(byte var1h, byte var1l) {
...
int RobinEngine::sub16729(int index) {
...
int RobinEngine::sub1675D(int index, int var1) {
