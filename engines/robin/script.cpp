...
void RobinScript::sub16C5C(int index, int8 var3) {
...
int RobinScript::getPackedStringStartRelativeIndex(int index) {
...
byte RobinScript::OC_checkIsoMap3() {
...
byte RobinScript::OC_compScriptForVal() {
...
byte RobinScript::OC_checkSelectedCharacter() {
...
byte RobinScript::OC_checkDelayedReactivation() {
...
byte RobinScript::OC_checkFunctionKeyPressed() {
...
byte RobinScript::OC_checkCodeEntered() {
...
void RobinScript::getSpeechVariant(int speechIndex, int speechVariant) {
...
void RobinScript::OC_getComputedVariantSpeech() {
...
void RobinScript::OC_getRotatingVariantSpeech() {
...
void RobinScript::OC_getComputedVariantSpeechIfMute() {
...
void RobinScript::OC_startSpeechIfSilent() {
...
void RobinScript::OC_startSpeech5() {
...
void RobinScript::OC_incScriptForVal() {
...
void RobinScript::OC_initScriptFor() {
...
void RobinScript::sub171AF(int16 var1, byte var2h, byte characterId, int16 var4) {
...
void RobinScript::OC_turnCharacterTowardsAnother() {
...
void RobinScript::OC_scrollAwayFromCharacter() {
...
void RobinScript::OC_setCurrentCharacterVar6() {
...
void RobinScript::OC_setCharacterScriptEnabled() {
...
void RobinScript::OC_setCharacterProperties() {
...
void RobinScript::OC_scrollViewPort() {
...
void RobinScript::OC_setRulesBuffer2Element() {
...
void RobinScript::OC_waitForEvent() {
...
void RobinScript::OC_loadFileAerial() {
...
void RobinScript::OC_startSpeechIfSoundOff() {
...
void RobinScript::OC_startSpeechWithoutSpeeker() {
...
void RobinScript::OC_displayCharacterStatBar() {
...
void RobinScript::OC_setCharacterMapColor() {
