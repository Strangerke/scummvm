...
byte RobinScript::compareValues(int var1, int oper, int var2) {
...
void RobinScript::computeOperation(byte *bufPtr, int oper, int var3) {
...
void RobinScript::sub1823E(byte index, byte var1, byte *curBufPtr) {
...
void RobinScript::sub17D40(bool &forceReturnFl) {
...
byte RobinScript::OC_compareCharacterId() {
...
byte RobinScript::OC_CompareByte16F02With() {
...
void RobinScript::OC_sub17D57_speech1() {
...
void RobinScript::OC_sub17DF9_speech1param() {
...
void RobinScript::sub171AF(int var1, int var2, int var4) {
...
void RobinScript::sub1818B(Common::Point pos) {
